...
outfile_base='../data/output/opendrift_alternative_hourly_190'
speedrun = False
...
degradation = True
volatilization = True
degradation_rate = 0.1*4.0509259259259263e-07 # from Dissayanake et al 2023, in 1/s, divided by ten
