...
outfile_base='../data/output/opendrift_alternative_hourly_180'
speedrun = False
...
degradation = True
volatilization = True
degradation_rate = 0.5*4.0509259259259263e-07 # half the value from Dissayanake et al 2023, in 1/s
